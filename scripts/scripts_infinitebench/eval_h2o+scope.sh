...
method="H2O" # Support PyramidKV, SnapKV, H2O, StreamingLLM, FullKV, CAM, ALLKV
max_capacity_prompts=2048 # 1024,2048 in paper
decoding_recent_size=256 # 128,256,512
...
for decoding_metric in "h2o" "fixed" "linear" "jump"
do
