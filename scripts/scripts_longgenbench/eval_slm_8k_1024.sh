...
method="StreamingLLM" # Support PyramidKV, SnapKV, PyramidInfer, H2O, StreamingLLM, ALLKV
max_capacity_prompts=4096 # 4096 in paper
decoding_recent_size=256 # 256 in paper
decoding_window_size=1024 # 512,1024 in paper
...
for decoding_metric in "slm"
do
    echo "Using method: ${method}, decoding_metric: ${decoding_metric}"
    source_path=results_longgenbench_8K/
