...
datasets = ["longbook_sum_eng"]

dataset2maxlen = {
    "longbook_sum_eng": 4096,
}

model2prompt = {
    "longbook_sum_eng": "You are given a book. Write a one-page summary of the book.\n\nBook:\n{context}\n\nNow, write a one-page summary of the book.\n\nSummary:",
}
    ...
    with open(args.data_file) as fp:
        for line in fp:
            ...
            if "llama2" in args.model_path.lower():
                prompt = build_chat_llama2(prompt)
